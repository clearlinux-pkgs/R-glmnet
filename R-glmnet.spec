...
Version  : 4.1
Release  : 84
URL      : https://cran.r-project.org/src/contrib/glmnet_4.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/glmnet_4.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610379191
