...
Version  : 2.0.8
Release  : 31
URL      : https://cran.r-project.org/src/contrib/glmnet_2.0-8.tar.gz
Source0  : https://cran.r-project.org/src/contrib/glmnet_2.0-8.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1493657491
