...
Version  : 3.0
Release  : 74
URL      : https://cran.r-project.org/src/contrib/glmnet_3.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/glmnet_3.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1573366893
