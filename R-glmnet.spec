...
Version  : 3.0.2
Release  : 78
URL      : https://cran.r-project.org/src/contrib/glmnet_3.0-2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/glmnet_3.0-2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1576529268
