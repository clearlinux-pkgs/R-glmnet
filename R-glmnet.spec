...
Version  : 2.0.9
Release  : 34
URL      : https://cran.r-project.org/src/contrib/glmnet_2.0-9.tar.gz
Source0  : https://cran.r-project.org/src/contrib/glmnet_2.0-9.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1493918550
